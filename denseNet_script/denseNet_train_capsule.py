...
data_dir = '/media/wall/4TB_HDD/full_dataset/0511_dataset/capsule/train_remove (25)'
...
# train_set, valid_set = torch.utils.data.random_split(dataset, [86 * 36, 40 * 36])
train_length = int(dataset.__len__() * 0.6)
# train_length = 20 * num_classes
