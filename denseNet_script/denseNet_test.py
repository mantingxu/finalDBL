...
def predict_capsule_id():
    logger_path = '../logger/logger-0710-all.txt'
    ...
    test_path = '/media/wall/4TB_HDD/full_dataset/0710_dataset/test/*.png'
    ...
    plt.savefig("../confusion_matrix_pill/confusion_matrix_all0710.png")
    test_dir = '/media/wall/4TB_HDD/full_dataset/0710_dataset/test'
