...
folders = os.listdir('/media/wall/4TB_HDD/full_dataset/0511_dataset/pill0603/train/pill_remove/')
# create folder
for folder in folders:
    each_pill_path = '/media/wall/4TB_HDD/full_dataset/0511_dataset/pill0621/train/pill_gaussian/{pill_fold}'.format(
        pill_fold=folder)
